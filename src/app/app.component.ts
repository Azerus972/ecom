...
export class AppComponent implements OnInit{
  ...
  sortFilters: any[] = [
    { name:'Nom (A à Z)', value:'name' },
    { name:'Prix (croissant)', value:'priceAsc' },
    { name:'Prix (high to low)', value:'priceDes' }
  ]

  customFilters: any[] = [
    { name:'Tous', value:'all', checked:true },
    { name:'Disponible', value:'available', checked:false },
    { name:'Indisponible', value:'unavailable', checked:false },
    { name:'Meilleure Vente', value:'bestseller', checked:false }
  ]

  priceFilters: any[] = [
    { name:'Tous', value:'all', checked:true },
    { name:'Prix < 30', value:'more_30000', checked:false },
    { name:'Prix > 30', value:'less_10000', checked:false }
  ]
